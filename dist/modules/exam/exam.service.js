...
const helper_service_clouldinary_1 = require('../../processors/helper/helper.service.cloudinary');
    ...
    try {
      ...
      if (fileImage) {
        ...
        const updateImage = await this.cloudinaryService.uploadFile(
          fileImage,
          cloudinary_constants_1.FILE_EXAM_THUMB,
          fileImage.filename,
          cloudinary_constants_1.RESOURCE_TYPE_IMAGE,
        );
      ...
      const valueFind = await this.examModel
