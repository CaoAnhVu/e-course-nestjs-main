...
const helper_service_cloudinary_1 = require('../../processors/helper/helper.service.cloudinary');
  ...
  async save(data) {
    ...
    try {
      const resultImage = await this.cloudinaryService.uploadFile(
        fileImage,
        cloudinary_constants_1.FILE_COURSE_THUMB,
        fileImage.filename,
        cloudinary_constants_1.RESOURCE_TYPE_IMAGE,
      );
      const resultVideo = await this.cloudinaryService.uploadFile(
        fileVideo,
        cloudinary_constants_1.FILE_COURSE_INTRO,
        fileVideo.fieldname,
        cloudinary_constants_1.RESOURCE_TYPE_VIDEO,
      );
...
exports.CourseService = CourseService = __decorate(
  [
    ...
    __metadata('design:paramtypes', [
      ...
      mongoose_1.Model,
      mongoose_1.Model,
      helper_service_cloudinary_1.CloudinaryService,
    ]),
  ],
  CourseService,
);
